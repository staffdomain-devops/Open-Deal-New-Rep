...
- [x] **ERR-01**: All scripts implement exponential backoff retry (up to 6 attempts, 60s max) on 429 and 5xx — reuse `utils.py` from Inbound
- [x] **ERR-02**: Each script writes DLQ sentinel at startup; updates with error details on failure
